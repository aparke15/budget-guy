  ...
  return (
    <section className="page">
      <div className="page-header">
        <div className="page-title-group">
          ...
          <p className="page-subtitle">
            recurring rules live here now. manual generation stays manual, with
            standard rules following category sign and transfer rules generating
            linked pairs.
          </p>
        </div>
        ...
        <div className="page-actions">
          <label className="field">
            <span className="field__label">generate month</span>
            <input
              type="month"
              value={month}
      ...
      <div className="section-card stack-md">
        <div className="section-header">
          <div className="section-title-group">
            <h2 className="section-title">rule manager</h2>
            <p className="section-subtitle">
              create, edit, duplicate, or remove recurring rules without hopping
              over to settings.
            </p>
          </div>
        </div>
        ...
        <div className="entity-list">
          ...
          {sortedRecurringRules.length === 0 ? (
            <p className="empty-state">
              no recurring rules yet. add one here, then generate a month when you
              want real transactions.
            </p>
          ) : null}
        </div>
      </div>
